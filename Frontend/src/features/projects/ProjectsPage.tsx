  ...
  return (
    <>
      <PageHeader
        ...
        description="A field-proven track record spanning Nigeria's premier upstream and midstream energy operators — from Chevron, Shell, ExxonMobil and Seplat to NNPC E&P and TotalEnergies."
      />
      ...
      <Container className="py-16 md:py-20">
        ...
        {isError && (
          <div className="rounded-xl border border-danger/20 bg-danger/5 p-6 text-center text-sm text-danger">
            Couldn't load client records from the database. Please try again shortly.
          </div>
        )}
          ...
          <>
            ...
            <div className="mt-4 flex items-center justify-between text-xs text-steel">
              ...
              <span className="flex items-center gap-1 font-mono uppercase tracking-wider text-gold-dark">
                <Shield size={13} /> 100% In-Country Delivery
              </span>
            </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-sm">
                    <thead className="border-b border-line bg-paper-raised text-xs font-bold uppercase tracking-wider text-ink">
                      <tr>
                        <th className="px-6 py-4">Client / Operator</th>
